...
def ajustar(con: sqlite3.Connection, slug: str, ref: str, delta: int,
    ...
    try:
        ...
        # Como no `collection.adjust`: o FOIL não se toca (2026-09-26). O
        # `qty_foil` é uma contagem à parte do `qty`, não uma fatia dele, e um
        # `−` nas próprias tira uma normal. Até 2026-09-26 cortava o foil aqui.
        con.execute(
