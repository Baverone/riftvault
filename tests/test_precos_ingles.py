"""Os preços só de ofertas em inglês (`precos.linguas`, 2026-09-15).

André: *"apenas cartas versao ingles"*. O filtro é na RECOLHA (`prices._usable`
via `prices.linguas`), onde a língua existe — a RiftScribe não tem língua por
impressão. Estes testes viveram no `test_top5.py` (o separador da tabela de
preços, apagado a 2026-09-19); a língua ficou, e os testes vieram para aqui.
...
class Base(unittest.TestCase):
    def setUp(self):
        ...
        from riftvault import config, prices
