"""Três blocos (André, 2026-09-14, à noite):
  ...
  2. COLEÇÃO EXTRA — artes alternativas, runas especiais, sobrenumeradas,
     ...
     de cada"*) — e estas voltaram ao playset a 2026-09-18 (*"muda novamente:
     Alt Art para playset, overnumbered continua 1 de cada"*). O alvo é por
     categoria, `master_set.um_de_cada`, e nunca sobe com os decks. Aparecem
...
class TestAlvos(Base):
    ...
    def test_uma_alt_art_de_unit_pede_o_playset_e_nao_conta(self):
        """Pediu 3 de 2026-09-14 à noite até 2026-09-16 (*"Alt Art e
        Overnumbered e assim quero apenas 1 de cada"*), 1 até 2026-09-18, e
        volta ao playset (*"muda novamente: Alt Art para playset"*). Os decks
        não lhe mexem no alvo (`test_voltar_1.py`)."""
        con = self.edicao()
    ...
    def test_uma_promo_pede_1_e_nao_conta(self):
        """1 desde 2026-09-19 (*"as Promo passam a 1 de cada"*); pediu 3 só
        durante 2026-09-18."""
        con = self.edicao()
    ...
    def test_a_runa_especial_pede_3_e_nao_conta(self):
        """A runa especial é a arte alternativa da runa: o playset do tipo
        desde 2026-09-18 (3, `master_targets_by_type`), como qualquer alt art
        (pediu 1 de 2026-09-16 a 2026-09-18). Este ficheiro desliga a retirada
        para o bloco continuar a ver-se; no config real está retirada."""
        con = self.edicao()
    ...
    def test_o_alvo_da_colecao_extra_e_por_categoria_e_o_master_set_o_playset(self):
        """*"Alt Art, overnumbered, etc etc mete Playset na contagem"*
        ...
        para playset, overnumbered continua 1 de cada"*); as promos pediram o
        playset durante 2026-09-18 e voltaram a 1 a 2026-09-19. Hoje o alvo
        da coleção extra é POR CATEGORIA (`master_set.um_de_cada`): alt arts a
...
class TestListasDeCompra(Base):
    ...
    def test_a_colecao_extra_continua_na_grelha_com_o_alvo_dela(self):
        ...
        grelha com o alvo dela — «tenho 1 de 3» na alt art (playset desde
        2026-09-18), 1 de cada na sobrenumerada e na promo (2026-09-15) —, e
        com cópias a faltar continua a não ser para comprar. Subir o alvo da
        alt art a 18/09 NÃO a põe na lista: acompanhar não é querer comprar."""
        from riftvault import collection
        con = self.edicao()
    ...
    def test_desligar_o_botao_volta_a_por_a_colecao_extra_nas_listas(self):
        ...
        # (2026-09-15 e 2026-09-19), a alt art de Unit e a runa especial o playset
