...
class TestAmbito(Base):
    ...
    def test_a_alt_art_conta_em_playset__o_token_fica_de_fora(self):
        """André, 2026-09-08: os `-T` estão fora; a alt art conta.
        ...
        Desde 2026-09-14 (*"muda tudo para playset"*) a alt art pede o playset
        do tipo, como a base.
        """
        con = self.v.connect()
        ...
        # O alvo é o do master set: a Unit base segue o playset do tipo, e a
        # arte alternativa também, desde 2026-09-18 (*"Alt Art para playset"*;
        # pediu 1 de 2026-09-16 a 2026-09-18).
